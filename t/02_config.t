...
like(dies {app->email_transport([]) }, qr/email_transport argument must be an Email::Sender::Transport instance/, 'die if email_transport arg not a transport obj');
...
like( dies {plugin 'SendEmail' => { sasl_username => 'username' } }, qr/sasl_username but no sasl_password/, 'test username with no password');
