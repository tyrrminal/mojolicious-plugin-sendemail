...
like($email->as_string, qr/^Content-Type: text\/html; charset=utf-8\r$/m, 'check html content type autodetection with template (register)');
...
like($email->as_string, qr/^Content-Type: text\/plain; charset=utf-8\r$/m, 'check text content type autodetection with template (simple)');
